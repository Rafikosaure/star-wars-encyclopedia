...
import ArrowToRight from '../../assets/images/right-arrow-next.svg'
            ...
            {!isLogged ? (
              <div className='header-div-connection-not-logged'>
                ...
                className='connection-link'>
                  ...
                  className="arrow-to-right-svg" /> Se connecter</p>
                <p
                tabIndex="0"
                ...
                className='connection-link'>
                  ...
                  src={ArrowToRight} 
                  alt='flèche vers la droite' 
                  className="arrow-to-right-svg" /> Créer un compte</p>
              </div>
            ) : (
              <>
              {loggedUser && (
              ...
              <div className='auth-links-div'>
                ...
                ><img src={ArrowToRight} alt='flèche vers la droite' className="arrow-to-right-svg" /> Déconnexion</p>
                <p 
                tabIndex="0" 
                onClick={() => navigate('/auth')}
                onKeyDown={(e) => e.key === 'Enter' && navigate('/auth')} 
                className='connection-link-logout'
                ><img src={ArrowToRight} alt='flèche vers la droite' className="arrow-to-right-svg" /> Créer un compte</p>
              </div>
