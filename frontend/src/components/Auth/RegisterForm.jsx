...
export default function RegisterForm() {
    ...
    <div className={`login-page-content`}>
        ...
        <form className='login-form' onSubmit={handleSubmit(onSubmit)}>
            ...
            <input type="text" id='name' className='login-form-input' name='name' placeholder='Entrez votre nom...' {...register("name")} onFocus={(e) => e.target.placeholder = ""} onBlur={(e) => e.target.placeholder = 'Entrez votre nom...'} required/>
            <label htmlFor="email" className='login-form-label'>Email</label>
            <input type="email" id='email' className='login-form-input' name='email' placeholder='Entrez votre email...' {...register("email")} onFocus={(e) => e.target.placeholder = ""} onBlur={(e) => e.target.placeholder = 'Entrez votre email...'} required/>
            <label htmlFor="password" className='login-form-label'>Mot de passe</label>
            <div className='login-form-password-div'>
                <input type="password" id='password' className='login-form-input' name='password' placeholder='Entrez votre mot de passe...' {...register("password")} onFocus={(e) => e.target.placeholder = ""} onBlur={(e) => e.target.placeholder = 'Entrez votre mot de passe...'} required />
            ...
            <div className='div-register-input-file-wrapper'>
                <label htmlFor='file' id='div-register-input-file'>
