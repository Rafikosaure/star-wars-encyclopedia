...
export default function Collapse() {
    ...
    const [isOpen, setIsOpen] = useState('close-collapse')

    const openCloseCollapse = () => {
        console.log("A construire !")
    }


  return (
    <div className='collapse-main'>
        <div className='collapse-bar'><h1 className='collapse-title'>CHARTE DU FORUM</h1><div className={`collapse-button ${isOpen}`} onClick={openCloseCollapse()} /></div>
